...
- `variables.nix`: A highly convenient configuration file that defines user preferences as variables (e.g., `desktop = "niri"`, `browser = "zen"`, `editor = "antigravity"`). These variables are used dynamically by the modules to install and configure the correct software.
