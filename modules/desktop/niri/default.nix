  ...
  home-manager.sharedModules = [
    (
      { config, ... }:
      {
        ...
        # which imports hm.kdl. We must write the KDL generated by wrapper-modules directly 
        # to hm.kdl so the system Niri sees our settings!
        xdg.configFile."niri/hm.kdl".text = lib.mkForce (
          inputs.wrapper-modules.lib.toKdl (import ./settings.nix {
            inherit
              config
              pkgs
              getExe
