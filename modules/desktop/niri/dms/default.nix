  ...
  home-manager.sharedModules = [
    (_: { 
      ...
      xdg.configFile."DankMaterialShell/settings.json".text = builtins.toJSON {
        ...
        ThemeName = "amoledBlack";  # Set your desired DMS theme here (must be installed in DMS's themes directory)
        customThemeFile = "amoledBlack"; # If using a custom theme file, specify it here (must be placed in DMS's themes directory)
