    ...
    (
      { config, ... }:
      {
        ...
        xdg.configFile."DankMaterialShell/settings.json".text = builtins.toJSON {
          ...
          profileImage = toString ./nix.png; # Set the path to your profile image for display in the overview and other DMS components. Make sure the image exists at this location and is in a supported format (e.g., PNG, JPEG).
