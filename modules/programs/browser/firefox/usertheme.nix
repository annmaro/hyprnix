{ config, ... }:
{
  userChrome = ''
    ...
    :root {
      ...
      --uc-base-colour: #${config.lib.stylix.colors.base00};          /* Absolute Black */
      --uc-highlight-colour: #${config.lib.stylix.colors.base01};     /* Dark Material Interface Layer */
      --uc-inverted-colour: #${config.lib.stylix.colors.base05};      /* High Contrast Text */
      --uc-muted-colour: #${config.lib.stylix.colors.base03};         /* Subdued/Inactive Gray */
      --uc-accent-colour: #${config.lib.stylix.colors.base0A};        /* Gruvbox Gold/Yellow Accent */
